...
if [ $? -eq 0 ]; then
    ...
    echo "   Main dashboard: http://localhost/dashboard-mainnet/"
echo "   Reporters page: http://localhost/dashboard-mainnet/reporters.html"
echo "   Search page: http://localhost/dashboard-mainnet/search.html"
