...
def main():
    ...
    try:
        ...
        print("   3. Visit http://localhost:8000/dashboard/reporters to see the reporters page")
        print("   4. Check http://localhost:8000/dashboard/api/reporter-fetcher-status for fetcher status")
